import{R as e}from"./iframe-D9ERtKCv.js";import{E as a,a as l,b as c,c as m,d as p,e as t}from"./item-tile-CWHKk72v.js";import{E as b}from"./signal-vdZNdvnL.js";import{E as y}from"./ebay-icon-heart-16-pUF9QWZc.js";import"./preload-helper-PPVm8Dsz.js";import"./utils-BjgL5LqD.js";import"./file-preview-card-DVbK0OqB.js";import"./icon-button-B3nNwOZy.js";import"./badge-CFajWv92.js";import"./menu-button-D59TPfaf.js";import"./menu-item-separator-N5d5zFFQ.js";import"./index-BkO6S4Io.js";import"./ebay-icon-tick-16-DjUrbpwK.js";import"./button-CLDE0FYD.js";import"./progress-spinner-eagrB8Wj.js";import"./ebay-icon-spinner-30-lXLIF8wX.js";import"./ebay-icon-chevron-down-12-fvkwXW5t.js";import"./index-B8Qar043.js";import"./floating-ui-CFXjJp_K.js";import"./jsx-runtime-u17CrQMm.js";import"./index-BcYG88M9.js";import"./index-D39YSVkc.js";import"./ebay-icon-overflow-vertical-16--hFMjer3.js";import"./ebay-icon-close-16-NAgfvFiO.js";import"./ebay-icon-delete-16-BJvA2TUo.js";import"./ebay-icon-play-16-BPUZ_OZ6.js";const R={title:"layout/ebay-item-tile",component:a,argTypes:{file:{description:"File object, can be raw platform `File` or an object containing `name`, `type`, and a `src` for the preview",table:{category:"File"}},layout:{control:{type:"select"},options:["gallery","list"],defaultValue:{summary:"gallery"},description:"The layout of the item-tile. The default is gallery. The list layout takes more horizontal space and is better for displaying more information."},href:{control:{type:"text"},description:"The URL to navigate to when the item-tile is clicked. If not provided, the item will not be clickable."},a11yExternalLinkText:{type:"string",control:{type:"text"},description:'When provided, the preview link opens in a new tab (`target="_blank"`) and this text is rendered in a visually-hidden `<span class="clipped">` inside the anchor for screen readers with a ` - ` prefix automatically added (e.g. `"opens in new window or tab"`).'},onAction:{action:"onAction",description:"Triggered when the action button is clicked",table:{category:"Events",defaultValue:{summary:""}}},EbayItemTileAction:{description:"Action component that will be used to render EbayIconButton and needs to have an `icon` and `aria-label` to be render.",options:["icon","aria-label"],control:{type:"select"}}},tags:["autodocs"],parameters:{docs:{description:{component:`## Usage
