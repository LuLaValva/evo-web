import{R as e}from"./iframe-wAW-JM2B.js";import{E as a,a as l,b as c,c as m,d as p,e as t}from"./item-tile-BbaiDYeo.js";import{E as b}from"./signal-DNya1k7k.js";import{E as y}from"./ebay-icon-heart-16-CnAK4nk4.js";import"./preload-helper-PPVm8Dsz.js";import"./utils-0CQvKkSO.js";import"./file-preview-card-DX7a8m4R.js";import"./icon-button-B2TTWGlx.js";import"./badge-Bc35sAsK.js";import"./menu-button-sg-15J6F.js";import"./menu-item-separator-BAPPPHr-.js";import"./index-BkO6S4Io.js";import"./ebay-icon-tick-16-Ck10dOf7.js";import"./button-Bs8C1gi6.js";import"./progress-spinner-SgjcloqO.js";import"./ebay-icon-spinner-30-CPB3T31_.js";import"./ebay-icon-chevron-down-12-D4-naV7Y.js";import"./index-B8Qar043.js";import"./floating-ui-B1auQXgj.js";import"./jsx-runtime-u17CrQMm.js";import"./index-BpzrpFaZ.js";import"./index-DbEuXtKf.js";import"./ebay-icon-overflow-vertical-16-CiBMbUOK.js";import"./ebay-icon-close-16-DXO71Wgg.js";import"./ebay-icon-delete-16-C_VOJEBV.js";import"./ebay-icon-play-16-E4N5Rl_1.js";const R={title:"layout/ebay-item-tile",component:a,argTypes:{file:{description:"File object, can be raw platform `File` or an object containing `name`, `type`, and a `src` for the preview",table:{category:"File"}},layout:{control:{type:"select"},options:["gallery","list"],defaultValue:{summary:"gallery"},description:"The layout of the item-tile. The default is gallery. The list layout takes more horizontal space and is better for displaying more information."},href:{control:{type:"text"},description:"The URL to navigate to when the item-tile is clicked. If not provided, the item will not be clickable."},a11yExternalLinkText:{type:"string",control:{type:"text"},description:'When provided, the preview link opens in a new tab (`target="_blank"`) and this text is rendered in a visually-hidden `<span class="clipped">` inside the anchor for screen readers with a ` - ` prefix automatically added (e.g. `"opens in new window or tab"`).'},onAction:{action:"onAction",description:"Triggered when the action button is clicked",table:{category:"Events",defaultValue:{summary:""}}},EbayItemTileAction:{description:"Action component that will be used to render EbayIconButton and needs to have an `icon` and `aria-label` to be render.",options:["icon","aria-label"],control:{type:"select"}}},tags:["autodocs"],parameters:{docs:{description:{component:`## Usage
