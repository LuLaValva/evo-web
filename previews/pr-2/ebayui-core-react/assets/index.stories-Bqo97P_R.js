import{R as e}from"./iframe-Bfsl7ac4.js";import{E as a,a as l,b as c,c as m,d as p,e as t}from"./item-tile-B-O-R_Uy.js";import{E as b}from"./signal-DivceKek.js";import{E as y}from"./ebay-icon-heart-16-BIR6EnTo.js";import"./preload-helper-PPVm8Dsz.js";import"./utils-CRmSFYmz.js";import"./file-preview-card-CqpOZOiJ.js";import"./icon-button-mGHiPe1a.js";import"./badge-Dcgdbb-I.js";import"./menu-button-BinbUg8g.js";import"./menu-item-separator-BlmmTkdp.js";import"./index-BkO6S4Io.js";import"./ebay-icon-tick-16-C-uLCz4y.js";import"./button-DWUY-Mlp.js";import"./progress-spinner-DLhywcx5.js";import"./ebay-icon-spinner-30-BA9xqqPe.js";import"./ebay-icon-chevron-down-12-DbNe7ngO.js";import"./index-B8Qar043.js";import"./floating-ui-DiqE6Rsc.js";import"./jsx-runtime-u17CrQMm.js";import"./index-J2nAnjZT.js";import"./index-N1VeNMCk.js";import"./ebay-icon-overflow-vertical-16-CBzmf-yM.js";import"./ebay-icon-close-16-CmBDouYD.js";import"./ebay-icon-delete-16-BL8KcMOi.js";import"./ebay-icon-play-16-Dsyg-Bb3.js";const R={title:"layout/ebay-item-tile",component:a,argTypes:{file:{description:"File object, can be raw platform `File` or an object containing `name`, `type`, and a `src` for the preview",table:{category:"File"}},layout:{control:{type:"select"},options:["gallery","list"],defaultValue:{summary:"gallery"},description:"The layout of the item-tile. The default is gallery. The list layout takes more horizontal space and is better for displaying more information."},href:{control:{type:"text"},description:"The URL to navigate to when the item-tile is clicked. If not provided, the item will not be clickable."},a11yExternalLinkText:{type:"string",control:{type:"text"},description:'When provided, the preview link opens in a new tab (`target="_blank"`) and this text is rendered in a visually-hidden `<span class="clipped">` inside the anchor for screen readers with a ` - ` prefix automatically added (e.g. `"opens in new window or tab"`).'},onAction:{action:"onAction",description:"Triggered when the action button is clicked",table:{category:"Events",defaultValue:{summary:""}}},EbayItemTileAction:{description:"Action component that will be used to render EbayIconButton and needs to have an `icon` and `aria-label` to be render.",options:["icon","aria-label"],control:{type:"select"}}},tags:["autodocs"],parameters:{docs:{description:{component:`## Usage
