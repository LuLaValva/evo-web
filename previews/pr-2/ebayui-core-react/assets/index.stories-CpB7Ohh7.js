import{R as e}from"./iframe-cI_aDJaz.js";import{E as a,a as l,b as c,c as m,d as p,e as t}from"./item-tile-Cx9uMwVw.js";import{E as b}from"./signal-BCtm6SOa.js";import{E as y}from"./ebay-icon-heart-16-BsxpktiJ.js";import"./preload-helper-PPVm8Dsz.js";import"./utils-eXMOq_Uq.js";import"./file-preview-card-C-H_TC8q.js";import"./icon-button-CULBnuuc.js";import"./badge-BLK77NuB.js";import"./menu-button-Bg6r2xCB.js";import"./menu-item-separator-AdeaCsXm.js";import"./index-BkO6S4Io.js";import"./ebay-icon-tick-16-ymUpDXml.js";import"./button-CG_PQLVx.js";import"./progress-spinner-BXU-ZkSU.js";import"./ebay-icon-spinner-30-C675cjT_.js";import"./ebay-icon-chevron-down-12-BeDRQ2-q.js";import"./index-B8Qar043.js";import"./floating-ui-D8ExVf9x.js";import"./jsx-runtime-u17CrQMm.js";import"./index-C6GDTbjJ.js";import"./index-oWrzIgUp.js";import"./ebay-icon-overflow-vertical-16-C4PjAUxH.js";import"./ebay-icon-close-16-DnoJ4pP1.js";import"./ebay-icon-delete-16-BZlovUk5.js";import"./ebay-icon-play-16-C0_pZ6v-.js";const R={title:"layout/ebay-item-tile",component:a,argTypes:{file:{description:"File object, can be raw platform `File` or an object containing `name`, `type`, and a `src` for the preview",table:{category:"File"}},layout:{control:{type:"select"},options:["gallery","list"],defaultValue:{summary:"gallery"},description:"The layout of the item-tile. The default is gallery. The list layout takes more horizontal space and is better for displaying more information."},href:{control:{type:"text"},description:"The URL to navigate to when the item-tile is clicked. If not provided, the item will not be clickable."},a11yExternalLinkText:{type:"string",control:{type:"text"},description:'When provided, the preview link opens in a new tab (`target="_blank"`) and this text is rendered in a visually-hidden `<span class="clipped">` inside the anchor for screen readers with a ` - ` prefix automatically added (e.g. `"opens in new window or tab"`).'},onAction:{action:"onAction",description:"Triggered when the action button is clicked",table:{category:"Events",defaultValue:{summary:""}}},EbayItemTileAction:{description:"Action component that will be used to render EbayIconButton and needs to have an `icon` and `aria-label` to be render.",options:["icon","aria-label"],control:{type:"select"}}},tags:["autodocs"],parameters:{docs:{description:{component:`## Usage
