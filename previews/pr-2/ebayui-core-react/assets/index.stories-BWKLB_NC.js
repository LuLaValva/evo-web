import{R as e}from"./iframe-DnFx30AO.js";import{E as a,a as l,b as c,c as m,d as p,e as t}from"./item-tile-NVmxjhzw.js";import{E as b}from"./signal-Dgpwwowp.js";import{E as y}from"./ebay-icon-heart-16-BRENgO9k.js";import"./preload-helper-PPVm8Dsz.js";import"./utils-BXtyrT7D.js";import"./file-preview-card-DAwoaVcw.js";import"./icon-button-DxNOzbWN.js";import"./badge-KH0TiTp8.js";import"./menu-button-F3QiH_nS.js";import"./menu-item-separator-9gb2k2w2.js";import"./index-BkO6S4Io.js";import"./ebay-icon-tick-16-CFZhvwRW.js";import"./button-7C8PdbfN.js";import"./progress-spinner-DGJSxG0K.js";import"./ebay-icon-spinner-30-BlZHKC_s.js";import"./ebay-icon-chevron-down-12-CISfwI7H.js";import"./index-B8Qar043.js";import"./floating-ui-C8wMyYLs.js";import"./jsx-runtime-u17CrQMm.js";import"./index-CzStWJ3Q.js";import"./index-Do6vtcYT.js";import"./ebay-icon-overflow-vertical-16-CP49Tpfp.js";import"./ebay-icon-close-16-Bg5632_4.js";import"./ebay-icon-delete-16-CExlmINt.js";import"./ebay-icon-play-16-Bes1tiu0.js";const R={title:"layout/ebay-item-tile",component:a,argTypes:{file:{description:"File object, can be raw platform `File` or an object containing `name`, `type`, and a `src` for the preview",table:{category:"File"}},layout:{control:{type:"select"},options:["gallery","list"],defaultValue:{summary:"gallery"},description:"The layout of the item-tile. The default is gallery. The list layout takes more horizontal space and is better for displaying more information."},href:{control:{type:"text"},description:"The URL to navigate to when the item-tile is clicked. If not provided, the item will not be clickable."},a11yExternalLinkText:{type:"string",control:{type:"text"},description:'When provided, the preview link opens in a new tab (`target="_blank"`) and this text is rendered in a visually-hidden `<span class="clipped">` inside the anchor for screen readers with a ` - ` prefix automatically added (e.g. `"opens in new window or tab"`).'},onAction:{action:"onAction",description:"Triggered when the action button is clicked",table:{category:"Events",defaultValue:{summary:""}}},EbayItemTileAction:{description:"Action component that will be used to render EbayIconButton and needs to have an `icon` and `aria-label` to be render.",options:["icon","aria-label"],control:{type:"select"}}},tags:["autodocs"],parameters:{docs:{description:{component:`## Usage
