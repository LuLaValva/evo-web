import{R as e}from"./iframe-Cc8YTtai.js";import{E as a,a as l,b as c,c as m,d as p,e as t}from"./item-tile-BrTq8P3I.js";import{E as b}from"./signal-6QLAJIA2.js";import{E as y}from"./ebay-icon-heart-16-B_exZbkX.js";import"./preload-helper-PPVm8Dsz.js";import"./utils-DpIiNW6n.js";import"./file-preview-card-DLTO5fcp.js";import"./icon-button-C_Rr7N8S.js";import"./badge-CT6yuO_W.js";import"./menu-button-r0HxHjy5.js";import"./menu-item-separator-C6pwcyVr.js";import"./index-BkO6S4Io.js";import"./ebay-icon-tick-16-DXCzwGZ_.js";import"./button-CB3Gxw5M.js";import"./progress-spinner-Do1Nvp-i.js";import"./ebay-icon-spinner-30-C0XDyZtd.js";import"./ebay-icon-chevron-down-12-tRfSyhx9.js";import"./index-B8Qar043.js";import"./floating-ui-CM1StCnD.js";import"./jsx-runtime-u17CrQMm.js";import"./index-BcL7Ib-7.js";import"./index-CIohBDtt.js";import"./ebay-icon-overflow-vertical-16-B1SQD6qV.js";import"./ebay-icon-close-16-DG77e6zp.js";import"./ebay-icon-delete-16-kO3oPaE_.js";import"./ebay-icon-play-16-780F3zD_.js";const R={title:"layout/ebay-item-tile",component:a,argTypes:{file:{description:"File object, can be raw platform `File` or an object containing `name`, `type`, and a `src` for the preview",table:{category:"File"}},layout:{control:{type:"select"},options:["gallery","list"],defaultValue:{summary:"gallery"},description:"The layout of the item-tile. The default is gallery. The list layout takes more horizontal space and is better for displaying more information."},href:{control:{type:"text"},description:"The URL to navigate to when the item-tile is clicked. If not provided, the item will not be clickable."},a11yExternalLinkText:{type:"string",control:{type:"text"},description:'When provided, the preview link opens in a new tab (`target="_blank"`) and this text is rendered in a visually-hidden `<span class="clipped">` inside the anchor for screen readers with a ` - ` prefix automatically added (e.g. `"opens in new window or tab"`).'},onAction:{action:"onAction",description:"Triggered when the action button is clicked",table:{category:"Events",defaultValue:{summary:""}}},EbayItemTileAction:{description:"Action component that will be used to render EbayIconButton and needs to have an `icon` and `aria-label` to be render.",options:["icon","aria-label"],control:{type:"select"}}},tags:["autodocs"],parameters:{docs:{description:{component:`## Usage
