import{R as e}from"./iframe-CYE9XGe7.js";import{E as a,a as l,b as c,c as m,d as p,e as t}from"./item-tile-Bjqw6pl0.js";import{E as b}from"./signal-D4kELyoR.js";import{E as y}from"./ebay-icon-heart-16-Bjdb-EkW.js";import"./preload-helper-PPVm8Dsz.js";import"./utils-DnSkARBU.js";import"./file-preview-card-CQOG5fJi.js";import"./icon-button-BUR9sROC.js";import"./badge-BYIqEnE6.js";import"./menu-button-DWOAfsbl.js";import"./menu-item-separator-2_kGHw0S.js";import"./index-BkO6S4Io.js";import"./ebay-icon-tick-16-DLP6SaG3.js";import"./button--y0meRjO.js";import"./progress-spinner-DQIeSDFs.js";import"./ebay-icon-spinner-30-emPXaJAb.js";import"./ebay-icon-chevron-down-12-DSbU3X7e.js";import"./index-B8Qar043.js";import"./floating-ui-DjeWYQ-B.js";import"./jsx-runtime-u17CrQMm.js";import"./index-rSp0_c3k.js";import"./index-CACDVuOz.js";import"./ebay-icon-overflow-vertical-16-0SkbeJ-4.js";import"./ebay-icon-close-16-CGZqc81W.js";import"./ebay-icon-delete-16-DMWL3EyX.js";import"./ebay-icon-play-16-B7EJCtHs.js";const R={title:"layout/ebay-item-tile",component:a,argTypes:{file:{description:"File object, can be raw platform `File` or an object containing `name`, `type`, and a `src` for the preview",table:{category:"File"}},layout:{control:{type:"select"},options:["gallery","list"],defaultValue:{summary:"gallery"},description:"The layout of the item-tile. The default is gallery. The list layout takes more horizontal space and is better for displaying more information."},href:{control:{type:"text"},description:"The URL to navigate to when the item-tile is clicked. If not provided, the item will not be clickable."},a11yExternalLinkText:{type:"string",control:{type:"text"},description:'When provided, the preview link opens in a new tab (`target="_blank"`) and this text is rendered in a visually-hidden `<span class="clipped">` inside the anchor for screen readers with a ` - ` prefix automatically added (e.g. `"opens in new window or tab"`).'},onAction:{action:"onAction",description:"Triggered when the action button is clicked",table:{category:"Events",defaultValue:{summary:""}}},EbayItemTileAction:{description:"Action component that will be used to render EbayIconButton and needs to have an `icon` and `aria-label` to be render.",options:["icon","aria-label"],control:{type:"select"}}},tags:["autodocs"],parameters:{docs:{description:{component:`## Usage
