import{R as e}from"./iframe-CvrPlpJJ.js";import{E as a,a as l,b as c,c as m,d as p,e as t}from"./item-tile-Datk5l4r.js";import{E as b}from"./signal-CzW5RqF4.js";import{E as y}from"./ebay-icon-heart-16-CjK_U7Qf.js";import"./preload-helper-PPVm8Dsz.js";import"./utils-vsX3SaYX.js";import"./file-preview-card-Cs6rcJI7.js";import"./icon-button-DJhW0EXK.js";import"./badge-C5Ar_ZiY.js";import"./menu-button-k-iMagNU.js";import"./menu-item-separator-DTrKmDcr.js";import"./index-BkO6S4Io.js";import"./ebay-icon-tick-16-B8RKMMIR.js";import"./button-CEnpUxWF.js";import"./progress-spinner-CjjJb5ZW.js";import"./ebay-icon-spinner-30-FWGTlfkd.js";import"./ebay-icon-chevron-down-12-u3WSHLmL.js";import"./index-B8Qar043.js";import"./floating-ui-CZPOV5yh.js";import"./jsx-runtime-u17CrQMm.js";import"./index-VaHFfBsh.js";import"./index-iFM6YhBv.js";import"./ebay-icon-overflow-vertical-16-CszEOtWf.js";import"./ebay-icon-close-16-6BC0oU6_.js";import"./ebay-icon-delete-16-tivQtXrw.js";import"./ebay-icon-play-16-DxCGt7tN.js";const R={title:"layout/ebay-item-tile",component:a,argTypes:{file:{description:"File object, can be raw platform `File` or an object containing `name`, `type`, and a `src` for the preview",table:{category:"File"}},layout:{control:{type:"select"},options:["gallery","list"],defaultValue:{summary:"gallery"},description:"The layout of the item-tile. The default is gallery. The list layout takes more horizontal space and is better for displaying more information."},href:{control:{type:"text"},description:"The URL to navigate to when the item-tile is clicked. If not provided, the item will not be clickable."},a11yExternalLinkText:{type:"string",control:{type:"text"},description:'When provided, the preview link opens in a new tab (`target="_blank"`) and this text is rendered in a visually-hidden `<span class="clipped">` inside the anchor for screen readers with a ` - ` prefix automatically added (e.g. `"opens in new window or tab"`).'},onAction:{action:"onAction",description:"Triggered when the action button is clicked",table:{category:"Events",defaultValue:{summary:""}}},EbayItemTileAction:{description:"Action component that will be used to render EbayIconButton and needs to have an `icon` and `aria-label` to be render.",options:["icon","aria-label"],control:{type:"select"}}},tags:["autodocs"],parameters:{docs:{description:{component:`## Usage
