import{R as e}from"./iframe-CZEx_NCO.js";import{E as a,a as l,b as c,c as m,d as p,e as t}from"./item-tile-BQXnTq6W.js";import{E as b}from"./signal-CmYcI2vv.js";import{E as y}from"./ebay-icon-heart-16-BU8digII.js";import"./preload-helper-PPVm8Dsz.js";import"./utils-C7pt_Obj.js";import"./file-preview-card-BVYN9uVF.js";import"./icon-button-D_2amOFF.js";import"./badge-C9BYQFnp.js";import"./menu-button-Dth35A25.js";import"./menu-item-separator-dLxjY6x2.js";import"./index-BkO6S4Io.js";import"./ebay-icon-tick-16-DZ_g10Cr.js";import"./button-8ULWN_et.js";import"./progress-spinner-BH3TDOve.js";import"./ebay-icon-spinner-30-z-L4gKXh.js";import"./ebay-icon-chevron-down-12-CEEfi1Y-.js";import"./index-B8Qar043.js";import"./floating-ui-DzTKy2lp.js";import"./jsx-runtime-u17CrQMm.js";import"./index-zCpPajRN.js";import"./index-rZRuZ0j8.js";import"./ebay-icon-overflow-vertical-16-BKFxy0OT.js";import"./ebay-icon-close-16-CKZtV4xH.js";import"./ebay-icon-delete-16-C-7s1C5u.js";import"./ebay-icon-play-16-DSmJVz-l.js";const R={title:"layout/ebay-item-tile",component:a,argTypes:{file:{description:"File object, can be raw platform `File` or an object containing `name`, `type`, and a `src` for the preview",table:{category:"File"}},layout:{control:{type:"select"},options:["gallery","list"],defaultValue:{summary:"gallery"},description:"The layout of the item-tile. The default is gallery. The list layout takes more horizontal space and is better for displaying more information."},href:{control:{type:"text"},description:"The URL to navigate to when the item-tile is clicked. If not provided, the item will not be clickable."},a11yExternalLinkText:{type:"string",control:{type:"text"},description:'When provided, the preview link opens in a new tab (`target="_blank"`) and this text is rendered in a visually-hidden `<span class="clipped">` inside the anchor for screen readers with a ` - ` prefix automatically added (e.g. `"opens in new window or tab"`).'},onAction:{action:"onAction",description:"Triggered when the action button is clicked",table:{category:"Events",defaultValue:{summary:""}}},EbayItemTileAction:{description:"Action component that will be used to render EbayIconButton and needs to have an `icon` and `aria-label` to be render.",options:["icon","aria-label"],control:{type:"select"}}},tags:["autodocs"],parameters:{docs:{description:{component:`## Usage
