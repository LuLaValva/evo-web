import{R as e}from"./iframe-NXL6QBQv.js";import{E as a,a as l,b as c,c as m,d as p,e as t}from"./item-tile-CqFe5CxP.js";import{E as b}from"./signal-By2U6Fev.js";import{E as y}from"./ebay-icon-heart-16-t99cURWx.js";import"./preload-helper-PPVm8Dsz.js";import"./utils-Dg3ZAozL.js";import"./file-preview-card-Ce4HgptJ.js";import"./icon-button-BoXPu2I0.js";import"./badge-jDxcpAnz.js";import"./menu-button-XzNvGSeF.js";import"./menu-item-separator-DA2F3rnZ.js";import"./index-BkO6S4Io.js";import"./ebay-icon-tick-16-CuCBrPq8.js";import"./button-Bt-jSmqK.js";import"./progress-spinner-DLHFsclf.js";import"./ebay-icon-spinner-30-Ca3Wz5wK.js";import"./ebay-icon-chevron-down-12-G_D_Ctb7.js";import"./index-B8Qar043.js";import"./floating-ui-DTNI5Nob.js";import"./jsx-runtime-u17CrQMm.js";import"./index-DTsXnBRX.js";import"./index-BBkSJIBr.js";import"./ebay-icon-overflow-vertical-16-D-nMfeO9.js";import"./ebay-icon-close-16-dT7-GHd0.js";import"./ebay-icon-delete-16-CiWX64uG.js";import"./ebay-icon-play-16-hO0x1Yju.js";const R={title:"layout/ebay-item-tile",component:a,argTypes:{file:{description:"File object, can be raw platform `File` or an object containing `name`, `type`, and a `src` for the preview",table:{category:"File"}},layout:{control:{type:"select"},options:["gallery","list"],defaultValue:{summary:"gallery"},description:"The layout of the item-tile. The default is gallery. The list layout takes more horizontal space and is better for displaying more information."},href:{control:{type:"text"},description:"The URL to navigate to when the item-tile is clicked. If not provided, the item will not be clickable."},a11yExternalLinkText:{type:"string",control:{type:"text"},description:'When provided, the preview link opens in a new tab (`target="_blank"`) and this text is rendered in a visually-hidden `<span class="clipped">` inside the anchor for screen readers with a ` - ` prefix automatically added (e.g. `"opens in new window or tab"`).'},onAction:{action:"onAction",description:"Triggered when the action button is clicked",table:{category:"Events",defaultValue:{summary:""}}},EbayItemTileAction:{description:"Action component that will be used to render EbayIconButton and needs to have an `icon` and `aria-label` to be render.",options:["icon","aria-label"],control:{type:"select"}}},tags:["autodocs"],parameters:{docs:{description:{component:`## Usage
