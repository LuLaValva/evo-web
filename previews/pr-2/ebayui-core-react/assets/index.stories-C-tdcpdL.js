import{R as e}from"./iframe-C50qMCT2.js";import{E as a,a as l,b as c,c as m,d as p,e as t}from"./item-tile-pq9BJG0h.js";import{E as b}from"./signal-3nLOGML6.js";import{E as y}from"./ebay-icon-heart-16-LH_NRP0K.js";import"./preload-helper-PPVm8Dsz.js";import"./utils-BHrfOxXn.js";import"./file-preview-card-DP4Nn4eP.js";import"./icon-button-BZwbZrfp.js";import"./badge-8brC4MmI.js";import"./menu-button-sZpeoCEY.js";import"./menu-item-separator-D96ZbgXt.js";import"./index-BkO6S4Io.js";import"./ebay-icon-tick-16-Bghc_sQg.js";import"./button-C1bcReI_.js";import"./progress-spinner-C9nJETzv.js";import"./ebay-icon-spinner-30-Cv6ia8Cf.js";import"./ebay-icon-chevron-down-12-U7v7bEsC.js";import"./index-B8Qar043.js";import"./floating-ui-CyyUdPMU.js";import"./jsx-runtime-u17CrQMm.js";import"./index-D70Q-IRM.js";import"./index-BiKinew4.js";import"./ebay-icon-overflow-vertical-16-CH3JfPum.js";import"./ebay-icon-close-16-C4UGblHk.js";import"./ebay-icon-delete-16-CDPRcTKI.js";import"./ebay-icon-play-16-Dbfrj0wi.js";const R={title:"layout/ebay-item-tile",component:a,argTypes:{file:{description:"File object, can be raw platform `File` or an object containing `name`, `type`, and a `src` for the preview",table:{category:"File"}},layout:{control:{type:"select"},options:["gallery","list"],defaultValue:{summary:"gallery"},description:"The layout of the item-tile. The default is gallery. The list layout takes more horizontal space and is better for displaying more information."},href:{control:{type:"text"},description:"The URL to navigate to when the item-tile is clicked. If not provided, the item will not be clickable."},a11yExternalLinkText:{type:"string",control:{type:"text"},description:'When provided, the preview link opens in a new tab (`target="_blank"`) and this text is rendered in a visually-hidden `<span class="clipped">` inside the anchor for screen readers with a ` - ` prefix automatically added (e.g. `"opens in new window or tab"`).'},onAction:{action:"onAction",description:"Triggered when the action button is clicked",table:{category:"Events",defaultValue:{summary:""}}},EbayItemTileAction:{description:"Action component that will be used to render EbayIconButton and needs to have an `icon` and `aria-label` to be render.",options:["icon","aria-label"],control:{type:"select"}}},tags:["autodocs"],parameters:{docs:{description:{component:`## Usage
