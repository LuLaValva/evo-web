import{R as e}from"./iframe-B5dskOpE.js";import{E as a,a as l,b as c,c as m,d as p,e as t}from"./item-tile-B5N_awcD.js";import{E as b}from"./signal-KJQ5R6ZY.js";import{E as y}from"./ebay-icon-heart-16-Dn-DB6Jd.js";import"./preload-helper-PPVm8Dsz.js";import"./utils-B9d6bwZz.js";import"./file-preview-card-DyQGrisz.js";import"./icon-button-HNV1j0P2.js";import"./badge-CUxTVstG.js";import"./menu-button-DnEP6Dz7.js";import"./menu-item-separator-xtAgL_mB.js";import"./index-BkO6S4Io.js";import"./ebay-icon-tick-16-B9W9QdR-.js";import"./button-Cxtv_RCR.js";import"./progress-spinner-Cp2VKODv.js";import"./ebay-icon-spinner-30-sSiVwCA0.js";import"./ebay-icon-chevron-down-12-BpWtSdxr.js";import"./index-B8Qar043.js";import"./floating-ui-B5Ppid1a.js";import"./jsx-runtime-u17CrQMm.js";import"./index-DN7o17bJ.js";import"./index-EV4WZBzj.js";import"./ebay-icon-overflow-vertical-16-3X8Sbfqk.js";import"./ebay-icon-close-16-Cav_5hig.js";import"./ebay-icon-delete-16-i1nWdtBC.js";import"./ebay-icon-play-16-BP4HdRYW.js";const R={title:"layout/ebay-item-tile",component:a,argTypes:{file:{description:"File object, can be raw platform `File` or an object containing `name`, `type`, and a `src` for the preview",table:{category:"File"}},layout:{control:{type:"select"},options:["gallery","list"],defaultValue:{summary:"gallery"},description:"The layout of the item-tile. The default is gallery. The list layout takes more horizontal space and is better for displaying more information."},href:{control:{type:"text"},description:"The URL to navigate to when the item-tile is clicked. If not provided, the item will not be clickable."},a11yExternalLinkText:{type:"string",control:{type:"text"},description:'When provided, the preview link opens in a new tab (`target="_blank"`) and this text is rendered in a visually-hidden `<span class="clipped">` inside the anchor for screen readers with a ` - ` prefix automatically added (e.g. `"opens in new window or tab"`).'},onAction:{action:"onAction",description:"Triggered when the action button is clicked",table:{category:"Events",defaultValue:{summary:""}}},EbayItemTileAction:{description:"Action component that will be used to render EbayIconButton and needs to have an `icon` and `aria-label` to be render.",options:["icon","aria-label"],control:{type:"select"}}},tags:["autodocs"],parameters:{docs:{description:{component:`## Usage
