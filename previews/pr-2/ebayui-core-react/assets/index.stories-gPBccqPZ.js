import{R as e}from"./iframe-Bla-1Hoa.js";import{E as a,a as l,b as c,c as m,d as p,e as t}from"./item-tile-DnYQAZ6o.js";import{E as b}from"./signal-Bvu4ZMAn.js";import{E as y}from"./ebay-icon-heart-16-BnSgoTUH.js";import"./preload-helper-PPVm8Dsz.js";import"./utils-bHc5dyq3.js";import"./file-preview-card-BkOkVlnw.js";import"./icon-button-BLF5GEoi.js";import"./badge-BSKHzJeD.js";import"./menu-button-Gs2pYhyS.js";import"./menu-item-separator-CVpaOsl0.js";import"./index-BkO6S4Io.js";import"./ebay-icon-tick-16-vJ37mIDM.js";import"./button-BWHDe7BD.js";import"./progress-spinner-BPGDSFjl.js";import"./ebay-icon-spinner-30-BAPL-QMy.js";import"./ebay-icon-chevron-down-12-B_MiHkOH.js";import"./index-B8Qar043.js";import"./floating-ui-_0xXdlYq.js";import"./jsx-runtime-u17CrQMm.js";import"./index-BFTxI4lN.js";import"./index-2gox0tsJ.js";import"./ebay-icon-overflow-vertical-16-DW4NCX0R.js";import"./ebay-icon-close-16-sPNM85of.js";import"./ebay-icon-delete-16-DuwgI8v2.js";import"./ebay-icon-play-16-NH5LMYRC.js";const R={title:"layout/ebay-item-tile",component:a,argTypes:{file:{description:"File object, can be raw platform `File` or an object containing `name`, `type`, and a `src` for the preview",table:{category:"File"}},layout:{control:{type:"select"},options:["gallery","list"],defaultValue:{summary:"gallery"},description:"The layout of the item-tile. The default is gallery. The list layout takes more horizontal space and is better for displaying more information."},href:{control:{type:"text"},description:"The URL to navigate to when the item-tile is clicked. If not provided, the item will not be clickable."},a11yExternalLinkText:{type:"string",control:{type:"text"},description:'When provided, the preview link opens in a new tab (`target="_blank"`) and this text is rendered in a visually-hidden `<span class="clipped">` inside the anchor for screen readers with a ` - ` prefix automatically added (e.g. `"opens in new window or tab"`).'},onAction:{action:"onAction",description:"Triggered when the action button is clicked",table:{category:"Events",defaultValue:{summary:""}}},EbayItemTileAction:{description:"Action component that will be used to render EbayIconButton and needs to have an `icon` and `aria-label` to be render.",options:["icon","aria-label"],control:{type:"select"}}},tags:["autodocs"],parameters:{docs:{description:{component:`## Usage
