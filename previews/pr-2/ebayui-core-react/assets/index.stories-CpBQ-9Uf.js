import{R as e}from"./iframe-BbJdDbXN.js";import{E as a,a as l,b as c,c as m,d as p,e as t}from"./item-tile-t7yqwu5R.js";import{E as b}from"./signal-CY7eXRk2.js";import{E as y}from"./ebay-icon-heart-16-sENKQITB.js";import"./preload-helper-PPVm8Dsz.js";import"./utils-ycvj0rge.js";import"./file-preview-card-Cj0jVzIE.js";import"./icon-button-BNNPikB5.js";import"./badge-DvVj9Fae.js";import"./menu-button-DoXY6AkI.js";import"./menu-item-separator-U678inO4.js";import"./index-BkO6S4Io.js";import"./ebay-icon-tick-16-G1xdP6nC.js";import"./button-Z0Q6xzVc.js";import"./progress-spinner-RQj4frD0.js";import"./ebay-icon-spinner-30-CMdkICbt.js";import"./ebay-icon-chevron-down-12-aqxw-WK6.js";import"./index-B8Qar043.js";import"./floating-ui-CJ9bI6wA.js";import"./jsx-runtime-u17CrQMm.js";import"./index-DnRgBIQE.js";import"./index-RD_Q8u6j.js";import"./ebay-icon-overflow-vertical-16-CH_WqLSv.js";import"./ebay-icon-close-16-R0SdcXue.js";import"./ebay-icon-delete-16-D96JNPS6.js";import"./ebay-icon-play-16-BiMNwUNN.js";const R={title:"layout/ebay-item-tile",component:a,argTypes:{file:{description:"File object, can be raw platform `File` or an object containing `name`, `type`, and a `src` for the preview",table:{category:"File"}},layout:{control:{type:"select"},options:["gallery","list"],defaultValue:{summary:"gallery"},description:"The layout of the item-tile. The default is gallery. The list layout takes more horizontal space and is better for displaying more information."},href:{control:{type:"text"},description:"The URL to navigate to when the item-tile is clicked. If not provided, the item will not be clickable."},a11yExternalLinkText:{type:"string",control:{type:"text"},description:'When provided, the preview link opens in a new tab (`target="_blank"`) and this text is rendered in a visually-hidden `<span class="clipped">` inside the anchor for screen readers with a ` - ` prefix automatically added (e.g. `"opens in new window or tab"`).'},onAction:{action:"onAction",description:"Triggered when the action button is clicked",table:{category:"Events",defaultValue:{summary:""}}},EbayItemTileAction:{description:"Action component that will be used to render EbayIconButton and needs to have an `icon` and `aria-label` to be render.",options:["icon","aria-label"],control:{type:"select"}}},tags:["autodocs"],parameters:{docs:{description:{component:`## Usage
