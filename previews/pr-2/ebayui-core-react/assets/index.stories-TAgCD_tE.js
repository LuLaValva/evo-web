import{R as e}from"./iframe-BsMSAYKT.js";import{E as a,a as l,b as c,c as m,d as p,e as t}from"./item-tile-DDPqo1ZO.js";import{E as b}from"./signal-CZi26mcn.js";import{E as y}from"./ebay-icon-heart-16-ByUoHlMw.js";import"./preload-helper-PPVm8Dsz.js";import"./utils-Dt779c6D.js";import"./file-preview-card-Bp4tYsue.js";import"./icon-button-BvKllP7H.js";import"./badge-BAZUGLw8.js";import"./menu-button-7ZbKBFpL.js";import"./menu-item-separator-BL-jSK-y.js";import"./index-BkO6S4Io.js";import"./ebay-icon-tick-16-9pI4sX0n.js";import"./button-BQ0E2YbP.js";import"./progress-spinner-Xgf5KJ7e.js";import"./ebay-icon-spinner-30-5hYSuXUC.js";import"./ebay-icon-chevron-down-12-l5APL_An.js";import"./index-B8Qar043.js";import"./floating-ui-BILtSWFG.js";import"./jsx-runtime-u17CrQMm.js";import"./index-BoQRjp2N.js";import"./index-DBX4zjJA.js";import"./ebay-icon-overflow-vertical-16-Ju-G9F81.js";import"./ebay-icon-close-16-CckyLXO7.js";import"./ebay-icon-delete-16-DtNue706.js";import"./ebay-icon-play-16-BVUKOtDq.js";const R={title:"layout/ebay-item-tile",component:a,argTypes:{file:{description:"File object, can be raw platform `File` or an object containing `name`, `type`, and a `src` for the preview",table:{category:"File"}},layout:{control:{type:"select"},options:["gallery","list"],defaultValue:{summary:"gallery"},description:"The layout of the item-tile. The default is gallery. The list layout takes more horizontal space and is better for displaying more information."},href:{control:{type:"text"},description:"The URL to navigate to when the item-tile is clicked. If not provided, the item will not be clickable."},a11yExternalLinkText:{type:"string",control:{type:"text"},description:'When provided, the preview link opens in a new tab (`target="_blank"`) and this text is rendered in a visually-hidden `<span class="clipped">` inside the anchor for screen readers with a ` - ` prefix automatically added (e.g. `"opens in new window or tab"`).'},onAction:{action:"onAction",description:"Triggered when the action button is clicked",table:{category:"Events",defaultValue:{summary:""}}},EbayItemTileAction:{description:"Action component that will be used to render EbayIconButton and needs to have an `icon` and `aria-label` to be render.",options:["icon","aria-label"],control:{type:"select"}}},tags:["autodocs"],parameters:{docs:{description:{component:`## Usage
