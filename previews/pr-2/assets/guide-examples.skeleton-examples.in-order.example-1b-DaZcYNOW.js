import{x as e,i as a}from"./_1x222syH.js";import"./_C-4lGbzW.js";e("H815CsS",t=>window.addEventListener("load",()=>{setTimeout(()=>{document.querySelector(".page-grid").innerHTML+=`
      <nav>
        <ul>
          <li><a href="#">World</a>
          <li><a href="#">U.S.</a>
  ...
  <main>
    ...
    `},3750)}));a();
//# sourceMappingURL=guide-examples.skeleton-examples.in-order.example-1b-DaZcYNOW.js.map
