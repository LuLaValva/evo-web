import{x as e,i as t}from"./_Fx7wwru-.js";import"./_Bx4yS0a6.js";e("DZqDKPd",i=>window.addEventListener("load",()=>{document.querySelector("button").addEventListener("click",function(s){document.querySelector("main").innerHTML+=`
    ...
    `,setTimeout(()=>{document.querySelectorAll(".skeleton:not([hidden])")[0].hidden=!0,document.querySelector("main").innerHTML+=`
      ...
      `},3e3)})}));t();
//# sourceMappingURL=guide-examples.skeleton-examples.csr.example-1-BWxn62bV.js.map
