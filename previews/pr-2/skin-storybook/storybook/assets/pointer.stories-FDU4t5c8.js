const h={title:"Skin/Tooltip/Pointer",parameters:{visual:{widths:[320,512]}}},m={left:{transform:"translateX(16px) translateY(-50%)",left:"100%",right:"auto",top:"20px",bottom:"auto"},"left-top":{transform:"translateX(16px)",left:"100%",right:"auto",top:"0",bottom:"auto"},"left-bottom":{transform:"translateX(16px)",left:"100%",right:"auto",top:"auto",bottom:"8px"},right:{transform:"translateX(-16px) translateY(-50%)",left:"auto",right:"100%",top:"20px",bottom:"auto"},"right-top":{transform:"translateX(-16px)",left:"auto",right:"100%",top:"2px",bottom:"auto"},"right-bottom":{transform:"translateX(-16px)",left:"auto",right:"100%",top:"auto",bottom:"4px"},top:{transform:"translateX(-50%)",left:"50%",right:"auto",top:"calc(100% + 12px)",bottom:"auto"},"top-left":{left:"4px",right:"auto",top:"calc(100% + 12px)",bottom:"auto"},"top-right":{left:"auto",right:"4px",top:"calc(100% + 12px)",bottom:"auto"},"bottom-right":{left:"auto",right:"4px",top:"auto",bottom:"calc(100% + 12px)"},"bottom-left":{left:"4px",right:"auto",top:"auto",bottom:"calc(100% + 12px)"},bottom:{transform:"translateX(-50%)",left:"50%",right:"auto",top:"auto",bottom:"calc(100% + 12px)"}};function t(v){const g=[];for(const u of Object.keys(m[v]))g.push(`${u}: ${m[v][u]}`);return g.join("; ")}const o=()=>`
