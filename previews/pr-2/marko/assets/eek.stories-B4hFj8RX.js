import{a as O,b as B,c as $,p,v as P,d as nn,h as an,e as X,f as tn}from"./dom-C0MY0u5h.js";import{$ as Y,b as o,c as s,a as c}from"./index-D4aRlw-G.js";import"./iframe-BkqRzvDk.js";import"./preload-helper-PPVm8Dsz.js";/* empty css             */function K(n,E,G={},x="",l=!1){const d=x+"	",{body:v,attrs:u}=gn(E,G,d);let k=n;return l&&(k=`@${G[k]||k}`),`<${k+u+(v?`>
${v.replace(/^|\n/gm,`$&${d}`)}
</${k}>`:"/>")}`}function gn(n,E,G){let x="",l="";for(const d in n)if(Object.prototype.hasOwnProperty.call(n,d)&&d!=="renderBody"){const v=n[d],u=d.replace(/([a-z])([A-Z])/g,(k,b,f)=>`${b}-${f.toLowerCase()}`);if(Array.isArray(v))for(const k of v)l+=K(u,k,E,G,!0);else v&&typeof v=="object"?d==="spread"?Object.keys(v).forEach(k=>{x+=` ${k}=${JSON.stringify(v[k])}`}):l+=K(u,v,E,G,!0):x+=` ${u}=${JSON.stringify(v)}`}return n.renderBody&&(l+=n.renderBody),{attrs:x,body:l}}const en=`<h1 style="display: flex; justify-content: space-between; align-items: center;">
    <span>
        evo-eek
    </span>
...
`,sn={title:"graphics & icons/evo-eek",component:bn,parameters:{docs:{description:{component:en}}},argTypes:{a11yText:{type:{name:"string",required:!0},control:"text",description:"Localized, the aria-label accessibility label for the eek component. This is for internationalization. It should use min, max, and rating in the label in order to demonstrate to screen readers the content on the component. Expected value `Energy efficiency class ${rating}. ${min} - ${max}`. May be set to `null` only if accessibility is provided through other means."},rating:{type:{name:"string",required:!0},control:"text",description:"The energy rating"},max:{type:{name:"string",required:!0},control:"text",description:"The maximum range"},min:{type:{name:"string",required:!0},control:"text",description:"The minimum range"},size:{type:"string",options:["regular (default)","large"],control:"inline-radio",description:"The size of the EEK."},"<div> attributes":{description:"All attributes and event handlers from [the native HTML `<div>` tag](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/div) will be passed through"}}},_=n=>({input:n});_.args={max:"A+++",min:"E",rating:"C"};_.parameters={docs:{source:{code:K("evo-eek",_.args)}}};const w=()=>({component:Dn,name:"A+++"});w.storyName="A+++";w.parameters={controls:{hideNoControlsWarning:!0},docs:{source:{code:Un}}};const j=()=>({component:Bn});j.storyName="A++";j.parameters={controls:{hideNoControlsWarning:!0},docs:{source:{code:Jn}}};const S=()=>({component:Nn,name:"A+"});S.storyName="A++";S.parameters={controls:{hideNoControlsWarning:!0},docs:{source:{code:Zn}}};const N=()=>({component:Ln,name:"A"});N.storyName="A";N.parameters={controls:{hideNoControlsWarning:!0},docs:{source:{code:Kn}}};const q=()=>({component:In});q.parameters={controls:{hideNoControlsWarning:!0},docs:{source:{code:Pn}}};_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`args => ({
  ...
  component: example5
})`,...q.parameters?.docs?.source}}};const cn=["Default","exampleOne","exampleTwo","exampleThree","exampleFour","invalidCombinations"];export{_ as Default,cn as __namedExportsOrder,sn as default,N as exampleFour,w as exampleOne,S as exampleThree,j as exampleTwo,q as invalidCombinations};
