import{b as I}from"./utils-DyU2_5R1.js";import{a as y,b as n,x as b,f as g,d,h as c,p as O,e as $,L as x,_ as u,o as h,s as T}from"./dom-x1z4vtvC.js";import"./iframe-cyLTEVRG.js";import"./preload-helper-PPVm8Dsz.js";const o="<div role=img></div>",s=" b",l=()=>{},A=(t,e)=>O(t.a,"aria-label",e),a=(t,e)=>A(t,e!==void 0?e:"Loading..."),i=(t,e)=>g(t.a,["skeleton",e]),D=d("STdZxFV",t=>c(t,"a")),_=n(5,t=>{b(t,"a",t.f,{role:1,"aria-label":1,class:1}),D(t)}),E=(t,e)=>{(({a11yText:v,class:m,...r})=>_(t,r))(e),i(t,e.class),a(t,e.a11yText)},S=y("Fyt6AHW",o,s,l,E),C=`<h1 style="display: flex; justify-content: space-between; align-items: center;">
    <span>
        evo-skeleton
    </span>
