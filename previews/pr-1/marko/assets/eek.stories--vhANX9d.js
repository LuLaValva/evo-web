import{a as O,b as B,c as $,p,v as P,d as nn,h as an,e as X,f as tn}from"./dom-x1z4vtvC.js";import{$ as Y,b as o,c as s,a as c}from"./index-BoCxi-ng.js";import"./iframe-cyLTEVRG.js";import"./preload-helper-PPVm8Dsz.js";/* empty css             */function K(n,E,G={},x="",l=!1){const d=x+"	",{body:v,attrs:u}=gn(E,G,d);let k=n;return l&&(k=`@${G[k]||k}`),`<${k+u+(v?`>
${v.replace(/^|\n/gm,`$&${d}`)}
