import{R as e}from"./iframe-CCJjaj_t.js";import{E as a,a as l,b as c,c as m,d as p,e as t}from"./item-tile-BCw-MvUf.js";import{E as b}from"./signal-B98OhR0R.js";import{E as y}from"./ebay-icon-heart-16-CgZhjfaM.js";import"./preload-helper-PPVm8Dsz.js";import"./utils-BTfZRIjJ.js";import"./file-preview-card-ssghqNnY.js";import"./icon-button-Dtdp4cvC.js";import"./badge-C2fXI0dd.js";import"./menu-button-DIvb8HIX.js";import"./menu-item-separator-kO6ZJTbh.js";import"./index-BkO6S4Io.js";import"./ebay-icon-tick-16-Do5SXf6a.js";import"./button-B9in-azf.js";import"./progress-spinner-BgnhU7qn.js";import"./ebay-icon-spinner-30-Dt-HF77V.js";import"./ebay-icon-chevron-down-12-DWmX13Iv.js";import"./index-B8Qar043.js";import"./floating-ui-D1VsqVOq.js";import"./jsx-runtime-u17CrQMm.js";import"./index-BsiF4W_c.js";import"./index-BI0GbTK3.js";import"./ebay-icon-overflow-vertical-16-DmvabdP4.js";import"./ebay-icon-close-16-BGO5ic3-.js";import"./ebay-icon-delete-16-Cp5sP2sH.js";import"./ebay-icon-play-16-Bbt2iRC4.js";const R={title:"layout/ebay-item-tile",component:a,argTypes:{file:{description:"File object, can be raw platform `File` or an object containing `name`, `type`, and a `src` for the preview",table:{category:"File"}},layout:{control:{type:"select"},options:["gallery","list"],defaultValue:{summary:"gallery"},description:"The layout of the item-tile. The default is gallery. The list layout takes more horizontal space and is better for displaying more information."},href:{control:{type:"text"},description:"The URL to navigate to when the item-tile is clicked. If not provided, the item will not be clickable."},a11yExternalLinkText:{type:"string",control:{type:"text"},description:'When provided, the preview link opens in a new tab (`target="_blank"`) and this text is rendered in a visually-hidden `<span class="clipped">` inside the anchor for screen readers with a ` - ` prefix automatically added (e.g. `"opens in new window or tab"`).'},onAction:{action:"onAction",description:"Triggered when the action button is clicked",table:{category:"Events",defaultValue:{summary:""}}},EbayItemTileAction:{description:"Action component that will be used to render EbayIconButton and needs to have an `icon` and `aria-label` to be render.",options:["icon","aria-label"],control:{type:"select"}}},tags:["autodocs"],parameters:{docs:{description:{component:`## Usage
