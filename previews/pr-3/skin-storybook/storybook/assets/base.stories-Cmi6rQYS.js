const p={title:"Skin/Button/Base",parameters:{visual:{rtl:!0}}},s=()=>'<button class="btn">Button</button>',n=()=>'<button class="btn btn--form">Button</button>',t=()=>'<button class="btn btn--form btn--slim"><svg class="icon icon--12" width="16" height="16"><use href="#icon-chevron-down-12"></use></svg></button>',e=()=>`
