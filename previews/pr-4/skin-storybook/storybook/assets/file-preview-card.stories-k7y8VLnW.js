const p={title:"Skin/File Preview Card",parameters:{visual:{rtl:!0},docs:{description:{component:`Storybook meta configuration for the file preview card stories.
@type {import('@storybook/html').Meta}`}}},decorators:[v=>`
