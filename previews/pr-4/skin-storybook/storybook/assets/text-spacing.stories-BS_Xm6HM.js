const e={title:"Skin/Button/Text Spacing",parameters:{visual:{rtl:!0}}},t=()=>'<button class="btn demo-a11y-text-spacing">Button</button>',s=()=>'<button class="btn btn--form demo-a11y-text-spacing">Button</button>',n=()=>`
