const g={title:"Skin/Floating Label",parameters:{visual:{rtl:!0}}},a=()=>`
...
\``,...f.parameters?.docs?.source}}};const x=["base","value","placeholder","disabledTextbox","invalidTextbox","invalidTextboxWithValue","invalidTextboxWithPlaceholder","longText","longTextInline","select","selectInline","selectInlineDoubled","TextArea","textSpacing","phoneInput"];export{d as TextArea,x as __namedExportsOrder,a as base,g as default,s as disabledTextbox,n as invalidTextbox,o as invalidTextboxWithPlaceholder,t as invalidTextboxWithValue,i as longText,c as longTextInline,f as phoneInput,l as placeholder,r as select,p as selectInline,b as selectInlineDoubled,u as textSpacing,e as value};
