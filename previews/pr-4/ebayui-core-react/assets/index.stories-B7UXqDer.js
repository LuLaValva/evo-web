import{R as e}from"./iframe-DwqJUzba.js";import{E as a,a as l,b as c,c as m,d as p,e as t}from"./item-tile-itKqSRjz.js";import{E as b}from"./signal-C34Kpvec.js";import{E as y}from"./ebay-icon-heart-16-nYfT0Msu.js";import"./preload-helper-PPVm8Dsz.js";import"./utils-Z9P_t24o.js";import"./file-preview-card-DGm3Cqw4.js";import"./icon-button-CF7okIXs.js";import"./badge-Cfb6wKLf.js";import"./menu-button-DZp-JBW9.js";import"./menu-item-separator-FIbTaHn2.js";import"./index-BkO6S4Io.js";import"./ebay-icon-tick-16-DaYEtIqf.js";import"./button-C2Nfzhvi.js";import"./progress-spinner-Dac_X6v2.js";import"./ebay-icon-spinner-30-DeWCPX8C.js";import"./ebay-icon-chevron-down-12-B-h7JWBq.js";import"./index-B8Qar043.js";import"./floating-ui-7XUflb45.js";import"./jsx-runtime-u17CrQMm.js";import"./index-CPWKNDz8.js";import"./index-DHTpfrx-.js";import"./ebay-icon-overflow-vertical-16-DPlCO0yf.js";import"./ebay-icon-close-16-hyknZ5gN.js";import"./ebay-icon-delete-16-CRGsgy11.js";import"./ebay-icon-play-16-B2y2pILI.js";const R={title:"layout/ebay-item-tile",component:a,argTypes:{file:{description:"File object, can be raw platform `File` or an object containing `name`, `type`, and a `src` for the preview",table:{category:"File"}},layout:{control:{type:"select"},options:["gallery","list"],defaultValue:{summary:"gallery"},description:"The layout of the item-tile. The default is gallery. The list layout takes more horizontal space and is better for displaying more information."},href:{control:{type:"text"},description:"The URL to navigate to when the item-tile is clicked. If not provided, the item will not be clickable."},a11yExternalLinkText:{type:"string",control:{type:"text"},description:'When provided, the preview link opens in a new tab (`target="_blank"`) and this text is rendered in a visually-hidden `<span class="clipped">` inside the anchor for screen readers with a ` - ` prefix automatically added (e.g. `"opens in new window or tab"`).'},onAction:{action:"onAction",description:"Triggered when the action button is clicked",table:{category:"Events",defaultValue:{summary:""}}},EbayItemTileAction:{description:"Action component that will be used to render EbayIconButton and needs to have an `icon` and `aria-label` to be render.",options:["icon","aria-label"],control:{type:"select"}}},tags:["autodocs"],parameters:{docs:{description:{component:`## Usage
