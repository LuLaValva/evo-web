import{R as e}from"./iframe-DuCPSXXX.js";import{E as a,a as l,b as c,c as m,d as p,e as t}from"./item-tile-eBmPjV2S.js";import{E as b}from"./signal-DAYxFFGh.js";import{E as y}from"./ebay-icon-heart-16-BzmUHFtz.js";import"./preload-helper-PPVm8Dsz.js";import"./utils-C1Y9tdg6.js";import"./file-preview-card-BbRqEQz7.js";import"./icon-button-BgAij1B1.js";import"./badge-BtflVJEw.js";import"./menu-button-jpS0H8yv.js";import"./menu-item-separator-bFoL5gqw.js";import"./index-BkO6S4Io.js";import"./ebay-icon-tick-16-rIj4XCTK.js";import"./button-BKB7KCnw.js";import"./progress-spinner-DmNK4__l.js";import"./ebay-icon-spinner-30-DCuF0eja.js";import"./ebay-icon-chevron-down-12-DCb4unFv.js";import"./index-B8Qar043.js";import"./floating-ui-CLLpgsLY.js";import"./jsx-runtime-u17CrQMm.js";import"./index-BqAalpfI.js";import"./index-kVP_P2F9.js";import"./ebay-icon-overflow-vertical-16-BtVSWO3W.js";import"./ebay-icon-close-16-C_jIZNex.js";import"./ebay-icon-delete-16-BREgwCDq.js";import"./ebay-icon-play-16-DBQzcCe9.js";const R={title:"layout/ebay-item-tile",component:a,argTypes:{file:{description:"File object, can be raw platform `File` or an object containing `name`, `type`, and a `src` for the preview",table:{category:"File"}},layout:{control:{type:"select"},options:["gallery","list"],defaultValue:{summary:"gallery"},description:"The layout of the item-tile. The default is gallery. The list layout takes more horizontal space and is better for displaying more information."},href:{control:{type:"text"},description:"The URL to navigate to when the item-tile is clicked. If not provided, the item will not be clickable."},a11yExternalLinkText:{type:"string",control:{type:"text"},description:'When provided, the preview link opens in a new tab (`target="_blank"`) and this text is rendered in a visually-hidden `<span class="clipped">` inside the anchor for screen readers with a ` - ` prefix automatically added (e.g. `"opens in new window or tab"`).'},onAction:{action:"onAction",description:"Triggered when the action button is clicked",table:{category:"Events",defaultValue:{summary:""}}},EbayItemTileAction:{description:"Action component that will be used to render EbayIconButton and needs to have an `icon` and `aria-label` to be render.",options:["icon","aria-label"],control:{type:"select"}}},tags:["autodocs"],parameters:{docs:{description:{component:`## Usage
