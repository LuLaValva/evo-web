import{R as e}from"./iframe-yAgKNpaP.js";import{E as a,a as l,b as c,c as m,d as p,e as t}from"./item-tile-CSlWHEHb.js";import{E as b}from"./signal-BHsJo63O.js";import{E as y}from"./ebay-icon-heart-16-UG6P7gA0.js";import"./preload-helper-PPVm8Dsz.js";import"./utils-D04eNHcQ.js";import"./file-preview-card-DsWeqLBb.js";import"./icon-button-B2NlU7xW.js";import"./badge-DBToeDti.js";import"./menu-button-CkxhOSxA.js";import"./menu-item-separator-Xvch3Dew.js";import"./index-BkO6S4Io.js";import"./ebay-icon-tick-16-DlmGRik2.js";import"./button-CPgFb1dW.js";import"./progress-spinner-ChIssl6E.js";import"./ebay-icon-spinner-30-BAqjc3i-.js";import"./ebay-icon-chevron-down-12-Ck4NjPKh.js";import"./index-B8Qar043.js";import"./floating-ui-DsabheMf.js";import"./jsx-runtime-u17CrQMm.js";import"./index-CT8ncNI6.js";import"./index-BjQjTUGu.js";import"./ebay-icon-overflow-vertical-16-BFPFPWRJ.js";import"./ebay-icon-close-16-DDtYdjq7.js";import"./ebay-icon-delete-16-BoGUYahm.js";import"./ebay-icon-play-16-BXTnYD1o.js";const R={title:"layout/ebay-item-tile",component:a,argTypes:{file:{description:"File object, can be raw platform `File` or an object containing `name`, `type`, and a `src` for the preview",table:{category:"File"}},layout:{control:{type:"select"},options:["gallery","list"],defaultValue:{summary:"gallery"},description:"The layout of the item-tile. The default is gallery. The list layout takes more horizontal space and is better for displaying more information."},href:{control:{type:"text"},description:"The URL to navigate to when the item-tile is clicked. If not provided, the item will not be clickable."},a11yExternalLinkText:{type:"string",control:{type:"text"},description:'When provided, the preview link opens in a new tab (`target="_blank"`) and this text is rendered in a visually-hidden `<span class="clipped">` inside the anchor for screen readers with a ` - ` prefix automatically added (e.g. `"opens in new window or tab"`).'},onAction:{action:"onAction",description:"Triggered when the action button is clicked",table:{category:"Events",defaultValue:{summary:""}}},EbayItemTileAction:{description:"Action component that will be used to render EbayIconButton and needs to have an `icon` and `aria-label` to be render.",options:["icon","aria-label"],control:{type:"select"}}},tags:["autodocs"],parameters:{docs:{description:{component:`## Usage
