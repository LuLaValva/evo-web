import{R as e}from"./iframe-C96jghHI.js";import{E as a,a as l,b as c,c as m,d as p,e as t}from"./item-tile-jrkEzQjr.js";import{E as b}from"./signal-CtEKyyeQ.js";import{E as y}from"./ebay-icon-heart-16-CZUDAWrb.js";import"./preload-helper-PPVm8Dsz.js";import"./utils-O9c2wTGS.js";import"./file-preview-card-fDdu_x7I.js";import"./icon-button-qK1bdYyg.js";import"./badge-DWubMgkl.js";import"./menu-button-l2_QD8sG.js";import"./menu-item-separator-CraxYK5v.js";import"./index-BkO6S4Io.js";import"./ebay-icon-tick-16-BdNpWKyh.js";import"./button-BIVF7x0v.js";import"./progress-spinner-5i4RbEB5.js";import"./ebay-icon-spinner-30-PmfXf7Gd.js";import"./ebay-icon-chevron-down-12-BKXBEcuB.js";import"./index-B8Qar043.js";import"./floating-ui-C7W3JrN8.js";import"./jsx-runtime-u17CrQMm.js";import"./index-petL1IR2.js";import"./index-Cd_Fk0aJ.js";import"./ebay-icon-overflow-vertical-16-BPShcYG8.js";import"./ebay-icon-close-16--MJZ45Iw.js";import"./ebay-icon-delete-16-lxVq7jdy.js";import"./ebay-icon-play-16-D0MBS0KC.js";const R={title:"layout/ebay-item-tile",component:a,argTypes:{file:{description:"File object, can be raw platform `File` or an object containing `name`, `type`, and a `src` for the preview",table:{category:"File"}},layout:{control:{type:"select"},options:["gallery","list"],defaultValue:{summary:"gallery"},description:"The layout of the item-tile. The default is gallery. The list layout takes more horizontal space and is better for displaying more information."},href:{control:{type:"text"},description:"The URL to navigate to when the item-tile is clicked. If not provided, the item will not be clickable."},a11yExternalLinkText:{type:"string",control:{type:"text"},description:'When provided, the preview link opens in a new tab (`target="_blank"`) and this text is rendered in a visually-hidden `<span class="clipped">` inside the anchor for screen readers with a ` - ` prefix automatically added (e.g. `"opens in new window or tab"`).'},onAction:{action:"onAction",description:"Triggered when the action button is clicked",table:{category:"Events",defaultValue:{summary:""}}},EbayItemTileAction:{description:"Action component that will be used to render EbayIconButton and needs to have an `icon` and `aria-label` to be render.",options:["icon","aria-label"],control:{type:"select"}}},tags:["autodocs"],parameters:{docs:{description:{component:`## Usage
