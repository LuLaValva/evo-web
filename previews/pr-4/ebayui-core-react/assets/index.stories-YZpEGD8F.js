import{R as e}from"./iframe-DQnhKaHl.js";import{E as a,a as l,b as c,c as m,d as p,e as t}from"./item-tile-CujduX6r.js";import{E as b}from"./signal-Clnl_NYJ.js";import{E as y}from"./ebay-icon-heart-16-DkQmU7mJ.js";import"./preload-helper-PPVm8Dsz.js";import"./utils-D2X7O10i.js";import"./file-preview-card-DC11GXIY.js";import"./icon-button-CgIZGu9g.js";import"./badge-CkXRa_Uq.js";import"./menu-button-CuzmWFbk.js";import"./menu-item-separator-BD0WbpM-.js";import"./index-BkO6S4Io.js";import"./ebay-icon-tick-16-ZqfyD2Jr.js";import"./button-uiDBkIp6.js";import"./progress-spinner-DApi83kL.js";import"./ebay-icon-spinner-30-81kbtJSp.js";import"./ebay-icon-chevron-down-12-DOpS-voT.js";import"./index-B8Qar043.js";import"./floating-ui-CiIr4v2V.js";import"./jsx-runtime-u17CrQMm.js";import"./index-DzPFwJSS.js";import"./index-Bc-BHUFm.js";import"./ebay-icon-overflow-vertical-16-Bcfc9mcM.js";import"./ebay-icon-close-16-BV2-knTf.js";import"./ebay-icon-delete-16-CdBobF0Y.js";import"./ebay-icon-play-16-GbhlAqR8.js";const R={title:"layout/ebay-item-tile",component:a,argTypes:{file:{description:"File object, can be raw platform `File` or an object containing `name`, `type`, and a `src` for the preview",table:{category:"File"}},layout:{control:{type:"select"},options:["gallery","list"],defaultValue:{summary:"gallery"},description:"The layout of the item-tile. The default is gallery. The list layout takes more horizontal space and is better for displaying more information."},href:{control:{type:"text"},description:"The URL to navigate to when the item-tile is clicked. If not provided, the item will not be clickable."},a11yExternalLinkText:{type:"string",control:{type:"text"},description:'When provided, the preview link opens in a new tab (`target="_blank"`) and this text is rendered in a visually-hidden `<span class="clipped">` inside the anchor for screen readers with a ` - ` prefix automatically added (e.g. `"opens in new window or tab"`).'},onAction:{action:"onAction",description:"Triggered when the action button is clicked",table:{category:"Events",defaultValue:{summary:""}}},EbayItemTileAction:{description:"Action component that will be used to render EbayIconButton and needs to have an `icon` and `aria-label` to be render.",options:["icon","aria-label"],control:{type:"select"}}},tags:["autodocs"],parameters:{docs:{description:{component:`## Usage
