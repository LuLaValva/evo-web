...
\`\`\``}}}},i=o=>e.createElement(c,{...o},e.createElement(a,{text:"August Campaign"}),e.createElement(a,{text:"4th of July Sale (paused)"}),e.createElement(a,{text:"Basic Offer"}),e.createElement(a,{text:"Basic Offer 1"}),e.createElement(a,{text:"Basic Offer 2"})),m=o=>e.createElement(c,{...o,floatingLabel:o.floatingLabel||"Default Label"},e.createElement(a,{text:"August Campaign"}),e.createElement(a,{text:"4th of July Sale (paused)"}),e.createElement(a,{text:"Basic Offer"}),e.createElement(a,{text:"Basic Offer 1"}),e.createElement(a,{text:"Basic Offer 2"})),r=o=>e.createElement(c,{...o,autocomplete:"list"},e.createElement(a,{text:"August Campaign"}),e.createElement(a,{text:"4th of July Sale (paused)"}),e.createElement(a,{text:"Basic Offer"}),e.createElement(a,{text:"Basic Offer 1"}),e.createElement(a,{text:"Basic Offer 2"})),d=o=>{const[y,C]=e.useState(p),[h,u]=e.useState("none"),[f,s]=e.useState(""),b=e.useRef(),g=n=>new Promise(t=>{clearTimeout(b.current),b.current=setTimeout(()=>{const l=p.filter(x=>x.name.toLowerCase().startsWith(n.toLowerCase())).slice(0,10);t(l)},500)}),E=async(n,t)=>{u("none"),s(t?.currentInputValue||"");const l=await g(t?.currentInputValue||"");C(l),u("list")},S=(n,t)=>{s(t.currentInputValue)};return e.createElement(c,{...o,name:"country",autocomplete:h,value:f,onInputChange:E,onSelect:S},e.createElement(I,{onClick:()=>s("")},e.createElement(O,null)),y.map(n=>e.createElement(a,{key:n.name,text:n.name,value:n.code})))};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`args => <EbayCombobox {...args}>
    ...
    </EbayCombobox>`,...i.parameters?.docs?.source}}};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`args => <EbayCombobox {...args} floatingLabel={args.floatingLabel || "Default Label"}>
        <EbayComboboxOption text="August Campaign" />
        <EbayComboboxOption text="4th of July Sale (paused)" />
        <EbayComboboxOption text="Basic Offer" />
        <EbayComboboxOption text="Basic Offer 1" />
        <EbayComboboxOption text="Basic Offer 2" />
    </EbayCombobox>`,...m.parameters?.docs?.source}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`args => <EbayCombobox {...args} autocomplete="list">
        <EbayComboboxOption text="August Campaign" />
        <EbayComboboxOption text="4th of July Sale (paused)" />
        <EbayComboboxOption text="Basic Offer" />
        <EbayComboboxOption text="Basic Offer 1" />
        <EbayComboboxOption text="Basic Offer 2" />
    </EbayCombobox>`,...r.parameters?.docs?.source}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`args => {
...
}`,...d.parameters?.docs?.source}}};const J=["Default","FloatingLabel","AutomaticallyFilterResults","SearchFiltering"];export{r as AutomaticallyFilterResults,i as Default,m as FloatingLabel,d as SearchFiltering,J as __namedExportsOrder,H as default};
