import{R as e}from"./iframe-mpt4QorT.js";import{E as a,a as l,b as c,c as m,d as p,e as t}from"./item-tile-Ce_lpXbj.js";import{E as b}from"./signal-Co8z42h4.js";import{E as y}from"./ebay-icon-heart-16-yZ7J2u0a.js";import"./preload-helper-PPVm8Dsz.js";import"./utils-CnISl2iB.js";import"./file-preview-card-CUZTWFko.js";import"./icon-button-CB_VDJQX.js";import"./badge-BgBgsc1P.js";import"./menu-button-Cl71tUu9.js";import"./menu-item-separator-BGIGk8IM.js";import"./index-BkO6S4Io.js";import"./ebay-icon-tick-16-CwltytPC.js";import"./button-CVf--A5D.js";import"./progress-spinner-Byw6x8TW.js";import"./ebay-icon-spinner-30-BjW-ZnpQ.js";import"./ebay-icon-chevron-down-12-Dsg4kko6.js";import"./index-B8Qar043.js";import"./floating-ui-B13sEfbZ.js";import"./jsx-runtime-u17CrQMm.js";import"./index-BPEgWsTQ.js";import"./index-BE-HOupr.js";import"./ebay-icon-overflow-vertical-16-DgRu_2YG.js";import"./ebay-icon-close-16-BGuYIi2o.js";import"./ebay-icon-delete-16-CnS96b7j.js";import"./ebay-icon-play-16-D0NAc3Tu.js";const R={title:"layout/ebay-item-tile",component:a,argTypes:{file:{description:"File object, can be raw platform `File` or an object containing `name`, `type`, and a `src` for the preview",table:{category:"File"}},layout:{control:{type:"select"},options:["gallery","list"],defaultValue:{summary:"gallery"},description:"The layout of the item-tile. The default is gallery. The list layout takes more horizontal space and is better for displaying more information."},href:{control:{type:"text"},description:"The URL to navigate to when the item-tile is clicked. If not provided, the item will not be clickable."},a11yExternalLinkText:{type:"string",control:{type:"text"},description:'When provided, the preview link opens in a new tab (`target="_blank"`) and this text is rendered in a visually-hidden `<span class="clipped">` inside the anchor for screen readers with a ` - ` prefix automatically added (e.g. `"opens in new window or tab"`).'},onAction:{action:"onAction",description:"Triggered when the action button is clicked",table:{category:"Events",defaultValue:{summary:""}}},EbayItemTileAction:{description:"Action component that will be used to render EbayIconButton and needs to have an `icon` and `aria-label` to be render.",options:["icon","aria-label"],control:{type:"select"}}},tags:["autodocs"],parameters:{docs:{description:{component:`## Usage
